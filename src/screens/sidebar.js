...
import logo from '../ui/logo-corsal.svg';
...
/*
    ...
    for(let i = 0; i < nav.length; i++){
        navigation.push(
            <li key={"nav-" + i + "-" + nav[i].slug}>
                <a href to={nav[i].slug} className={"aic link noul flex c333"}>
    ...
    return (
        <div class="container-sm" className="sidebar rel">
            <a href="/course.js" className="logo bl">
